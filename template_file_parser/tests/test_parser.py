...
class TestParser(TestCase):
    def test_unsafe(self):
        ...
        out_file = os.path.join(os.path.dirname(__file__), 'test_files/unsafe-res.txt')
        expected_file = out_file = os.path.join(os.path.dirname(__file__), 'test_files/unsafe-expected.txt')
    ...
    def test_safe(self):
        ...
        'b':'world'}
        in_file = os.path.join(os.path.dirname(__file__), 'test_files/in.txt')
        out_file = os.path.join(os.path.dirname(__file__), 'test_files/safe-res.txt')
        expected_file = out_file = os.path.join(os.path.dirname(__file__), 'test_files/safe-expected.txt')
